...
public class D_Post {
    ...
    // 게시글 1개당 여러개의 댓글이 작성 (1:N)
    /*
        Post와 Comment는 1:N의 관계
        - Post가 하나일 때 여러 개의 Comment가 연결

        1) mappedBy = "테이블명"
            : Comment 엔티티의 'post' 필드와 매핑 (참조하는 테이블의 필드명)
    ...
    /*
        연관 관계 편의 메서드
            ...
            >> 해당 설정을 하지 않으면 JPA의 영속성 컨텍스트가 양방향관계를 완전하게 이해하지 못함
            ...
            cf) 양방향 관계
                ...
                - Comment는 하나의 Post를 속함 (@ManyToOne)
