...
public class StudentService {
    ...
    public List<StudentResponseDto> getAllStudents() {
        ...
        try {
            ...
            throw new ResponseStatusException(
                    ...
                    "Error occurred while fetching student", // 에러 메세지
                    e // 예외 원인
            );
        }
    }
    ...
    public StudentResponseDto getStudentById(Long id) {
        ...
        try {
            B_Student student = studentRepository.findById(id)
                    .orElseThrow(() -> new Error("Student not fount with id: " + id));
    ...
    public StudentResponseDto updateStudent(Long id, StudentUpdateRequestDto studentDto) {
        ...
        try {
            ...
            // 1) 새로운 객체(PK가 없음) 저장: INSERT SQL 실행(새로 저장)
            // 2) 기존 객체(PK가 있음) 저장: UPDATE SQL 실행 (기존 데이터 수정)
