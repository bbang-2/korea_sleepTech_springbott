...
public class N_REST_API {
    /*
        ...
        1) HTTP 프로토콜: 웹에서 클라이언트-서버 간 데이터를 주고받기 위한 통신 규약 (GET, POST, PUT, DELETE)
        ...
        1. 명사 사용 (리소스명 또한 동사가 아닌 명사 사용)
            ...
            >> 자원에 대한 행위: URI 아니라 HTTP 매서드로 표현
    ...
    /*
        ...
        - /me
            ...
            EX) 로그인한 사용자 정보 조회(내정보 조회): api/v1/users/me (GET)
